...
class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfNoneBooks(){
        //Given
        List<Book>listOfNoneBooks = new ArrayList<>();
        when(libraryDatabaseMock.listBooksInHandsOf(any(LibraryUser.class))).thenReturn(listOfNoneBooks);
        //When
        LibraryUser libraryUser = new LibraryUser("Raf", "Smo", "123456");
